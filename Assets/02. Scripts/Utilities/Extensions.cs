...
{
    // UI 요소의 월드 중심점 구하기
    public static Vector3 GetUIWorldPosition(this RectTransform rectTransform)
    {
    ...
    // 마우스 위치를 월드 좌표로 변환
    public static Vector3 GetMouseWorldPosition(this Canvas canvas, Vector3 screenPosition)
    {
